...
class StoreFiberRequest extends FormRequest
{
    ...
    {
        return auth()->check() && $this->user()->isCustomer();
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'tariff_id.required' => 'انتخاب تعرفه الزامی است.',
            'tariff_id.exists' => 'تعرفه انتخاب‌شده معتبر نیست.',

            'modem_id.exists' => 'مودم انتخاب‌شده معتبر نیست.',
